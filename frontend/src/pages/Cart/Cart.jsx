...
const Cart = () => {
  ...
  return (
    <div className='cart p-6 max-w-4xl mx-auto'>
      ...
      <button onClick={handleCheckout} className="w-full bg-blue-600 text-white font-semibold py-3 rounded-lg hover:bg-blue-700 transition duration-200">PROCEED TO CHECKOUT</button>
    </div>
